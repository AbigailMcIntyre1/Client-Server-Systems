...
// ----------------------------------------------------------------------------------------------------------------
// the JDialogBox that comes up when the user registers
// ----------------------------------------------------------------------------------------------------------------
...
public class ChatRegisterDialog extends JDialog
                            implements ActionListener, KeyListener
{
    ...
    public void actionPerformed(ActionEvent e) 
    {
        ...
        if(!password.contains(" ") && !username.contains(" "))      // if the username and password don't contain spaces
        {
            dispose();
        }
        else
        {
            ...
            JOptionPane.showMessageDialog(this, "Username/Password may not contain spaces.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
